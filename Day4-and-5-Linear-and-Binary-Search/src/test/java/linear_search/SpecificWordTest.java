...
import org.linear_search.SpecificWordInAListOfSentences.SpecificWordInAListOfSentences2;
...
public class SpecificWordTest {
    ...
    void specificWordSentenceTest(){
        ...
        String word="you";
        String found= SpecificWordInAListOfSentences2.linearSearch(sentences,word);
